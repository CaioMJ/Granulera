...
rslider bounds(658, 514, 100, 70) range(0, 1, 0, 1, 0.01) text("Range") channel("LfoFilterRange") trackercolour(188, 151, 49, 255) textcolour(255, 255, 255, 255)
rslider bounds(560, 514, 100, 70) range(0, 15, 0, 0.5, 0.01) text("Frequency") channel("LfoFilterFreq") trackercolour(188, 151, 49, 255) textcolour(255, 255, 255, 255)
...
//BACKLOG:
;Adicionar f table para carregar arquivos de audio
;Fazer um variante de efeito ao inves de synth que granula input ao vivo
