...
label bounds(400, 10, 388, 45) fontColour(188, 151, 49, 255) text("G R A N U L E R A") channel("label3")
...
//GRAINS
label bounds(352, 88, 116, 20) fontColour(255, 255, 255, 255) text("G R A I N S")
