...
rslider bounds(772, 260, 100, 70) range(0.01, 1, 1, 1, 0.01) text("Sustain") channel("FilterSustain") trackercolour(188, 151, 49, 255) textcolour(255, 255, 255, 255)
rslider bounds(870, 260, 100, 70) range(0.01, 10, 0.1, 0.5, 0.01) text("Release") channel("FilterRelease") trackercolour(188, 151, 49, 255) textcolour(255, 255, 255, 255)
...
//PANNING
    gaSigL, gaSigR pan2 aSigFilter, kGlobalPan
