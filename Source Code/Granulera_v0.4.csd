...
soundfiler bounds(642, 322, 300, 200) channel("Filer")
...
rslider bounds(744, 142, 100, 70) range(1, 100, 1, 0.5, 0.01) text("Resonance") channel("FilterReson") trackercolour(188, 151, 49, 255) textcolour(255, 255, 255, 255)
...
instr CheckForAudio      
 ...
 if kNewFileTrg == 1 then				; if a new file has been loaded...
    print 2
  event	"i","LoadAudioIntoTable",0,0.1 			; call instrument to update sample storage function table 
 endif  
...
instr LoadAudioIntoTable
giChannels filenchnls gSfilepath

giAudioL	ftgen	21,0,0,1,gSfilepath,0,0,1
if giChannels==2 then
  giAudioR	ftgen	22,0,0,1,gSfilepath,0,0,2
endif
...
//GRAIN SUMMING:	
aGrainSum sum aGrain1 * kOsc1Vol * .05, aGrain2 * kOsc2Vol * .05, aGrainAudioL, aGrainAudioR
...
//PANNING
aSigL, aSigR pan2 aSigFilter, kGlobalPan ;aGrainSum, kGlobalPan 

//REVERB
aVerbL, aVerbR reverbsc aSigL, aSigR, kReverbSize, 6000

aSigWetDryL ntrpol aSigL, aVerbL, kReverbSend
aSwigWetDryR ntrpol aSigR, aVerbR, kReverbSend

//OUTPUT
aSigSumL = aSigWetDryL * aAmpEnv * kGlobalVol * kcc1
aSigSumR = aSwigWetDryR * aAmpEnv * kGlobalVol * kcc1
outs aSigSumL, aSigSumR 
endin
</CsInstruments>
<CsScore>
i "CheckForAudio" 0 0 [60*60*24*7]
f0 z
</CsScore>
</CsoundSynthesizer>
<bsbPanel>
